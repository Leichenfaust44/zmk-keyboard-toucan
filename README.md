...
This config uses the **5-col layout** (outer pinky columns unused), making key positions identical to the [Piantor Pro BT](https://github.com/Leichenfaust44/zmk-config) from Keebart config for easy cross-board maintenance.
